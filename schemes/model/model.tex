...
\begin{document}
    \begin{tikzpicture}
        ...
        \node at ( -3,0) [rectangle,fill=blue!20,draw] (newstructure) {\textbf{Ток через устройство}};
        \node at ( 3,0) [rectangle,fill=blue!20,draw] (current) {\textbf{Формирующаяся структура}};
